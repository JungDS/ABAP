...
DATA: GT_FIELDCAT      TYPE LVC_T_FCAT,
      GT_FIELDCAT_TEMP TYPE LVC_T_FCAT,
      GT_FIELDCAT_CURR TYPE LVC_T_FCAT,
...
DATA: GV_CONTAINER  TYPE SCRFNAME VALUE 'CT_0100',
      GV_CONTAINER1 TYPE SCRFNAME VALUE 'CT_0200',
      GV_SAVE       TYPE C        VALUE 'U',
      GV_POS        TYPE I,
      GV_REPID2     TYPE SY-REPID.
...
MODULE ALV_INIT_DISPLAY_0100 OUTPUT.
  ...
  IF GR_GRID1 IS NOT BOUND.
    ...
    "-- ALV F4 등록
    PERFORM REGIST_ALV_F4_0100 USING GR_GRID1.
