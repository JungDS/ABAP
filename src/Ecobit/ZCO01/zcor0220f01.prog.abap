...
FORM SELECTED_DATA_RTN .
  ...
  SELECT A~RVERS  AS VERSN, A~WRTTP, A~RYEAR AS GJAHR,
   ...
   GROUP BY A~RVERS, A~WRTTP, A~RYEAR, A~ROBJNR,
            A~RKSTAR, B~KTEXT
        ...
        WHEN 'F1HSL'.
          ...
          SELECT DISTINCT
           ...
           INTO CORRESPONDING FIELDS OF TABLE @LR_POSID
            FROM PRPS
           WHERE OBJNR IN @r_objnr.  "modi  bsgsm_fcm_20210706
...
FORM GET_FIELDCATLOG_DATA2 .
  ...
  CALL FUNCTION 'K_KKB_FIELDCAT_MERGE'
    EXPORTING
      I_CALLBACK_PROGRAM     = SY-REPID
      I_STRUCNAME            = 'ZCOS0210' "ABAP DIC. 정의된 STRUCTURE
      I_BYPASSING_BUFFER     = ABAP_TRUE
      I_INCLNAME             = SY-REPID
    CHANGING
      CT_FIELDCAT            = LT_FIELDCAT[]
              ...
              CASE GT_NODES-HLEVEL.
                ...
                WHEN OTHERS.
                  ...
                  IF SY-SUBRC <> 0.
                    ...
                    CLEAR: GS_OUTTAB-KSTAR,  GS_OUTTAB-KTEXT,
                           GS_OUTTAB-F1HSL,  GS_OUTTAB-FPLAN,
                           GS_OUTTAB-FDIFF.
                ...
                LOOP AT GT_CSKA WHERE KSTAR >= GT_VALUES-VFROM
                  ...
                  LOOP AT GT_DATA ASSIGNING FIELD-SYMBOL(<LS_DATA>)
                    ...
                    IF GS_OUTTAB-KSTAR CP '04*' OR  "매출 계정은 음수로 표시
                      ...
                      GS_OUTTAB-FPLAN =  GS_OUTTAB-FPLAN * '-1'.
                    ENDIF.

                    GS_OUTTAB-FDIFF = GS_OUTTAB-FPLAN - GS_OUTTAB-F1HSL.
                    ...
                    CLEAR: GS_OUTTAB-F1HSL, GS_OUTTAB-FPLAN,
                           GS_OUTTAB-FDIFF.
          ...
          IF LV_INDEX = 1.
            ...
            IF SY-SUBRC = 0.
              ...
              MOVE: LS_OUTTAB1-F1HSL TO GS_OUTTAB-F1HSL,
                    LS_OUTTAB1-FPLAN TO GS_OUTTAB-FPLAN,
                    LS_OUTTAB1-FDIFF TO GS_OUTTAB-FDIFF.
            ...
            IF SY-SUBRC = 0.
              ...
              CASE LV_OPE.
                ...
                WHEN '+'.
                  ...
                  GS_OUTTAB-FPLAN = GS_OUTTAB-FPLAN + LS_OUTTAB2-FPLAN.
                  GS_OUTTAB-FDIFF = GS_OUTTAB-FDIFF + LS_OUTTAB2-FDIFF.
