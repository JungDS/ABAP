*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCOV0020
*   generation date: 2019.06.19 at 13:14:50
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCOV0020            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCOV0020'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCOV0020_EXTRACT
TOTAL = ZCOV0020_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCOV0020'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCOV0020-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCOV0020_EXTRACT
TOTAL = ZCOV0020_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCOV0020-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCOV0020'
...
TOTAL = ZCOV0020_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCOV0020-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCOV0020-UPD_FLAG NE SPACE.
