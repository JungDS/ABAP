...
DATA: GV_FSUM TYPE HSLXX9_CS,   " 반영전 합계
      GV_ASUM TYPE HSLXX9_CS,   " 실적금액 합계
      GV_ISUM TYPE HSLXX9_CS,   " 증감금액 합계
      GV_TSUM TYPE HSLXX9_CS,   " 반영 후 합계
      GV_PSUM TYPE HSLXX9_CS.   " 가용금액 합계
