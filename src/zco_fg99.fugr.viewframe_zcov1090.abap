*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCOV1090
*   generation date: 2019.06.26 at 15:59:12
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCOV1090            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCOV1090'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCOV1090_EXTRACT
TOTAL = ZCOV1090_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCOV1090'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCOV1090-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCOV1090_EXTRACT
TOTAL = ZCOV1090_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCOV1090-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCOV1090'
...
TOTAL = ZCOV1090_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCOV1090-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCOV1090-UPD_FLAG NE SPACE.
